...
export const projectData: Project[] = [
  {
    title: "Fit Harmony",
    description: "FIT_HARMONY는 헬스장 운영 및 회원 관리를 위한 통합 플랫폼의 프론트엔드 애플리케이션입니다. React 기반의 SPA(Single Page Application)로 구축되었으며, 트레이너와 회원 간의 소통, 인바디 분석, 일정 관리, 커뮤니티 등의 기능을 제공합니다.",
    comment: "",
    start_date: "2025-06-23",
    end_date: "2025-07-21",
    image: "fh_image.JPG",
    link: "https://fitharmony.wa4b.site",
    github: "https://github.com/Wasa-B/FIT_HARMONY_FRONT",
    skills: ["React", "JavaScript", "express", "tailwindcss","PostgreSQL", "AWS_EC2"],
  },
  {
    title: "DocGen",
    description: "DocGen은 AI 기반 프로젝트 문서 자동 생성 플랫폼의 프론트엔드 애플리케이션입니다. React 기반의 SPA(Single Page Application)로 구축되었으며, 프로젝트 관리, 문서 생성, 타임라인 관리, 공지사항 등의 기능을 제공합니다.",
    comment: "",
  ...
  {
    title: "InPick",
    description: `AI 기반 여행 일정 생성 및 추천 시스템의 프론트엔드 서비스입니다.
